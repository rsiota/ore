...
var lightPalette = colorPalette{
	...
	delStrong:       lipgloss.Color("#ffcecb"),
	searchWash:      lipgloss.Color("#fff8c5"),
	searchStrong:    lipgloss.Color("#ffe08a"),
...
var darkPalette = colorPalette{
	...
	addStrong:       lipgloss.Color("#1b4332"),
	delStrong:       lipgloss.Color("#5c1a1f"),
	searchWash:      lipgloss.Color("#3d2e00"),
	searchStrong:    lipgloss.Color("#6b4e00"),
